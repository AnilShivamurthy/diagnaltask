...
const ListingPageTwo = () => {
    ...
    return (
            ...
            {
               (pageTwo !== undefined) ? pageTwo && pageTwo.map((pageTwoItems, index)=>{
                        return( pageTwoItems['content-items'].content.map((imageItem, imageIndex)=>{
                                return (
                                    <div key={index}>
